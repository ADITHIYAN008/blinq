          ...
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-semibold text-primary-foreground text-white">
                  Blinq
                </span>
              </div>
            ...
            <div className="mx-auto mt-16 max-w-3xl text-center">
              <h1 className="text-4xl font-bold leading-tight tracking-tighter text-white sm:text-5xl md:text-6xl lg:text-7xl">
                Transform Your Instagram Engagement with Blinq
              </h1>

              <p className="mt-6 text-lg text-blue-200">
                Blinq revolutionizes how you connect with your audience on
            ...
            <div className="relative h-40 md:h-60 w-[97%]  mt-10">
              <Image
                src="/hero.png"
